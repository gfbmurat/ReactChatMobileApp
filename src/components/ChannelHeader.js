...
const ChannelHeader = (channelName) => {
    ...
    return (
        <div className="mt-4 bg-gray-100 flex justify-between items-center p-3 rounded-md xs:flex-col">
            <div className="flex justify-center text-center items-center text-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 20l4-16m2 16l4-16M6 9h14M4 15h14" />
                </svg>
                <h3 className="text-gray-700 font-medium xs:mb-2">{currentChannel?.name}</h3>
            </div>
