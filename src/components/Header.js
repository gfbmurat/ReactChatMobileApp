    ...
    return (
        <header className="flex justify-between items-center py-3 border-b-2 border-gray-400">
            <div className="flex">
                ...
                <div className="ml-2 lg:ml-0 text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 font-black text-lg">React Chat App</div>
            </div>

            {/* Icons */}
            <div className="flex items-center">
                <button onClick={updateTheme} className="text-gray-500 mr-2" >
                    {
