...
const Header = ({ isOpen, setIsOpen }) => {
    ...
    return (
        <header className="flex justify-between items-center py-3 border-b-2 border-gray-400">
            <div className="flex">
                <button className={`text-gray-600 ${isOpen ? '' : 'lg:hidden'} dark:text-gray-300`} onClick={toggleButon}>
            ...
            <div className="flex items-center">
                <button ref={themeRef} onClick={updateTheme} className="text-gray-500 mr-2 hover:animate-pulse" >
                    {
                ...
                <button ref={buttonRef} onClick={signout} className="text-gray-500 object-cover pl-2 flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
